...
@Sql(scripts = "/sql/clientes/clientes-insert.sql",executionPhase =
        Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = "/sql/clientes/clientes-delete.sql",executionPhase =
...
public class ClienteIT {
    ...
    public void criarCliente_comDadosValidos_RetornarClienteComStatus201(){
        ClienteResponseDto responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(
                        testClient, "toby@email.com", "123456"
                                                                 ))
    ...
    public void criarCliente_comDadosInvalidos_RetornarErrorMessageComStatus422(){
        ...
        testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira","911.910.640-85"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void buscarCliente_ComDadosDeTokenDoCliente_RetornarClienteStatus200() {
        ClienteResponseDto responseBody = testClient
                .get()
