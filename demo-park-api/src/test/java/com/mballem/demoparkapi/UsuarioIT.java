...
@Sql(scripts = "/sql/usuarios/usuarios-insert.sql",executionPhase =
...
public class UsuarioIT {
    ...
    public void createUsuario_ComUsernameInvalido_RetornaErrorMessageStatus422(){
        ...
        //testaremos outras possibilidades de erro de usuario invalido
        ...
        responseBody =testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@mail.","123456"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult()
    ...
    @Test
    public void createUsuario_ComSenhaInvalida_RetornaErrorMessageStatus422(){
        ErrorMessage responseBody =testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        responseBody =testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@mail.com","1234567"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult()
    ...
    @Test
    public void buscarListaUsuarios_SeListaNaoNula_RetornarUsuariosComStatus200(){
